...
function SectionCommission(){
    ...
    return(
        <section id="commissionHome">
            <h2>/commissions</h2>
            <p>You can order me <strong>pixel art</strong> and / or <strong>digital painting furry art</strong>. Depending of what you ask and the options you wish, prices go from 10€ to 55€.</p>
